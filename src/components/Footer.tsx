    ...
    <footer className="relative mt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-card rounded-[2.5rem] p-12 flex flex-col items-center space-y-8">
          <div className="text-3xl font-black text-gradient uppercase tracking-tighter">Gourav.</div>
          
          <div className="flex justify-center space-x-4">
            {[
              { icon: Github, href: 'https://github.com/g-tanwar' },
              { icon: Linkedin, href: 'https://linkedin.com/in/gourav-tanwar' },
          ...
          <p className="text-gray-500 text-sm font-medium">
            &copy; {currentYear} Gourav Tanwar. Built with <span className="text-white">React 19</span> & <span className="text-blue-400">Tailwind V4</span>.
          </p>
        </div>
      </div>
    </footer>
